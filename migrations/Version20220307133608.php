 ...
 */
final class Version20220307133608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE point (id INT AUTO_INCREMENT NOT NULL, id_parcours_id INT NOT NULL, pos INT NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, text LONGTEXT DEFAULT NULL, INDEX IDX_B7A5F324762A0D2C (id_parcours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
